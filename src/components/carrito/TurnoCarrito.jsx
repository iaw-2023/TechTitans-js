...
const TurnoCarrito = ({ turno, index, confirmarEliminarElemento }) => {
  ...
  const { id, fecha_turno, hora_turno, cancha } = turno
  ...
  return (
    <div className="card-info-container" style={{ padding: "5vh" }}>
      <Card className="card border-primary mb-3 text-bg-dark">
        <Card.Body>
          ...
          <button type="button" className="btn btn-danger" onClick={() => confirmarEliminarElemento(id)}>
            Borrar turno
          </button>
        </Card.Body>
      </Card>
